...
public class Caregiver {
    ...
    /**
    public void deleteAvailability(Date d) throws SQLException {
        ConnectionManager cm = new ConnectionManager();
        Connection con = cm.createConnection();

        String deleteAvailability = "DELETE FROM Availability WHERE Username = ? AND Time = ?;";
        try {
